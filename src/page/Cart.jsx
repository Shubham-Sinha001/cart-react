    ...
    <div >
      {cart.length > 0 ? (
        ...
        <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-center ">
          ...
          <div className="w-[100%] md:w-[60%] flex flex-col p-2 mt-12">
            {cart.map((item, index) => {
          ...
          <div className="w-[100%] md:w-[40%] mt-5 flex flex-col ">
            ...
            <div className="flex flex-col">
              ...
              <button className="bg-green-700
               hover:bg-purple-50 rounded-lg text-white transition duration-300 ease-linear mt-5 border-2 border-green-600 font-bold hover:text-green-700 p-3 text-xl mb-10">
